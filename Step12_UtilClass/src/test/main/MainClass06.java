...
/*
 * 	java 에서 어떤 데이터를 key : value 처럼 짝으로 관리하고 싶으면
 * 	HashMap 객체를 사용한다.
 * 	key 의 generic 도 마음대로 지정 할 수 있지만 보통 String type 으로 한다.
 * 	value 의 generic 은 그때그때 다르지만 value 가 여러가지 type 이면 보통 Object로 지정한다.
 */
