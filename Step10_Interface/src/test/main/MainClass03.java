...
public class MainClass03 {
	// anonymous inner class 를 이용해서 interface type 의 참조 값 얻어내기
	...
	public static void main(String[] args) {
		useRemocon(r1);
		// anonymous local inner class 를 이용해서 interface type 의 참조 값 얻어내기
		...
		useRemocon(r2);
		// 메소드를 호출하면서 Remocon type 을 즉석에서 얻어내서 전달하기
