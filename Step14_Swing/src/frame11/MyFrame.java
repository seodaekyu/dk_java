   ...
   public static void main(String[] args) {
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			// 3. 연산의 결과를 출력한다.
			// 연산의 결과를 문자열로 만든다.
			String resultNum = Double.toString(result); // toString 을 통해 문자열로 바꿔 준 후 밑의 코드에 대입
